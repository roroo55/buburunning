...
public class HuajiaoFailurePresentation2D : MonoBehaviour
{
    public GameObject presentationRoot;
    public RawImage cgDisplay;
    public VideoPlayer videoPlayer;
    public VideoClip huajiaoCg;
    public AudioSource bgmSource;
    public AudioClip huajiaoBgm;
    public bool loopCg;
    public bool loopBgm = true;
    public bool pauseGameplay = true;
    public bool pauseOtherAudio = true;
    public bool returnOnMouseClick = true;
    [Min(0f)]
    ...
    public void ShowFailure()
    {
        ...
        if (videoPlayer != null && huajiaoCg != null)
        {
            videoPlayer.Stop();
            videoPlayer.clip = huajiaoCg;
            videoPlayer.isLooping = loopCg;
            videoPlayer.Prepare();
        }

        if (bgmSource != null && huajiaoBgm != null)
        {
            bgmSource.clip = huajiaoBgm;
    ...
    public void ReturnToStartScreen()
    {
        ...
        // Time and audio state persist through a scene reload, so restore them
        // before loading the clean start-screen state.
        Time.timeScale = 1f;
    ...
    void PrepareVideoTexture()
    {
            ...
            || runtimeTexture.height != height)
        {
            ...
            runtimeTexture.name = "Huajiao CG Runtime Texture";
    ...
    {
        LastVideoError = message ?? "Unknown video playback error.";
        Debug.LogError(
            "Huajiao CG video playback failed: " + LastVideoError,
            this);
    }
